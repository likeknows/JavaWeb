...
<div id="content">
    <div id="right">
        ...
        <div class="form-group">
            ...
            <input type="text" id="uid" name="uid" class="form_control"
                   onblur="showerr('uid','账号不能为空','账号格式正确','账号格式不正确');checkuid()" onfocus="showmsg('uid','账号长度在6到12位之间')"
                   placeholder="请输入用户名">
            <span class="msg_default"></span>
        </div>
        <div class="form-group">
            <label for="upass">密码:</label>
            <input type="password" id="upass" name="upass" class="form_control"
                   onblur="showerr('upass','密码不能为空','密码格式正确','密码格式不正确')"  onfocus="showmsg('upass','密码长度在6到12位之间')"
                   placeholder="请输入密码">
            <span class="msg_default"></span>
        </div>
        <div class="form-group">
            <label for="upass2">确认密码:</label>
            <input type="password" name="upass2" class="form_control"
                   onblur="showerr('upass2','密码不能为空','密码格式正确','密码格式不正确')" onfocus="showmsg('upass2','密码长度在6到12位之间')"
                   placeholder="请确认密码">
            <span class="msg_default"></span>
        </div>
        <div class="form-group">
            <label for="uphone">手机号:</label>
            <input type="text" id="uphone" name="uphone" class="form_control"
                   onblur="showphone()" onfocus="showmsg('phone','请输入正确手机号')"
                   placeholder="请确认密码">
            <span class="msg_default"></span>
        </div>
        <div class="form-group">
