...
<body>
    <div class="row" id="content">
        ...
        <div id="consultList" name="consultList">

            <%-- 咨询列表及回复 --%>
            <c:forEach items="${consultList }" var="consult">
                <div id="con" style="border: 1px solid #ff6700">
        ...
        <div id="addConsult">
            ...
            <form action="addConsult" method="get">
                <input type="text" name="gid" value="${goods.gid }" hidden="hidden">
                <h6>请输入咨询问题：</h6>
                <textarea id="text" name="question" cols="120" rows="3"></textarea><br>
